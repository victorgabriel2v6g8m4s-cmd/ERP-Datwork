        ...
        <div className="space-y-4 font-sans text-xs sm:text-sm">
            ...
            <div className="space-y-1.5">
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <label className="px-3 py-1.5 border border-dashed border-slate-300 hover:border-indigo-500 rounded-xl font-bold text-xs text-slate-500 hover:text-indigo-600 transition-colors cursor-pointer bg-slate-50/50">
            ...
            {/* 📁 Galeria de Mídias e Documentos Técnicos do Produto (COMPONENTE RECICLADO) */}
